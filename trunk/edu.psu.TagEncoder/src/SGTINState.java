...
public class SGTINState extends TagEncoderState implements ActionListener{
	...
	private JLabel itemRefLabel = new JLabel("Item Reference:");
	...
	private JLabel itemRefLabel2 = new JLabel("Item Reference:");
	...
	private JLabel itemRefLabel3 = new JLabel("");
	private JLabel serialLabel3 = new JLabel("");

	private JTextField headerText = new JTextField("30");
	...
	private JTextField itemRefText = new JTextField();
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(eSource == fillButton){
			...
			partitionText.setText("2");
			compPrefixText.setText("0867360217");
			itemRefText.setText("005");
			serialText.setText("889520129");
		}
	...
	public void messageReceived(Message message){
		...
		if (message.getTagCount() == 0) {
			...
			try {
				...
				if(uri[3].equalsIgnoreCase("sgtin-96")){ 
					uri[3] = "30";
					...
					itemRefLabel3.setText(uri[6]);
					serialLabel3.setText(uri[7]);
				}
				else{
					String header = uri[3];
