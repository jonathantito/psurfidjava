...
public class TDTFrontEnd { // demonstration front-end application which makes use of the TDT package
	...
	try {
	   ...
	   // extraparams.put("taglength","96"); // for inbound levels 'PURE_IDENTITY' or 'LEGACY', the taglength must be specified as "64" or "96"
...
//		String inbound = "urn:epc:tag:gid-96:123456789.12345678.123456789";
	    String inbound = "urn:epc:tag:sscc-96:0.0123456789.1234567";
//	    String inbound = "001100010000100000110011101100101101110111011001000000000000000000000000000000000000000000000000";
